	...
	if(bWasSuccessFul)
	{
		...
		if(FJsonSerializer::Deserialize(Reader, JsonObject))
		{
			if(JsonObject->HasField("playerData"))
			{
				...
				// 	PlayerEquipmentInfo.FrameIndex = 10000000;
				// 	PlayerEquipmentInfo.WheelIndex = 20000000;
				// 	PlayerEquipmentInfo.HeadgearIndex = 30000000;
				// 	PlayerEquipmentInfo.GlassesIndex = 40000000;
				// 	PlayerEquipmentInfo.JerseyIndex = 50000000;
				// 	PlayerEquipmentInfo.GlovesIndex = 60000000;
				// 	PlayerEquipmentInfo.SocksIndex = 70000000;
				// 	PlayerEquipmentInfo.ShoesIndex = 80000000;
				//
				// 	FPlayerAvatarInfo PlayerAvatarInfo;
				// 	PlayerAvatarInfo.UserName = "Test";
				// 	PlayerAvatarInfo.Country = ECountry::EUN;
				// 	PlayerAvatarInfo.Level = 1;
				// 	PlayerAvatarInfo.Exp = 0;
				// 	PlayerAvatarInfo.Gender = EGenderType::EMale;
				// 	PlayerAvatarInfo.BodyColor = EBodyColor::EYellow;
				// 	PlayerAvatarInfo.Bicycle = EBicycleType::ERoad;
				// 	PlayerAvatarInfo.PlayerEquipmentInfo = PlayerEquipmentInfo;
				//
				// 	ZGameInstance->SetPlayerAvatarInfo(PlayerAvatarInfo);
				// 	
				//
				// 	///// Server GetItemList /////////////////////////////////////////////////////////////////
				// 	TArray<int32> Items;
				...
				// 	Items.Add(80000001);
				//
				// 	ZGameInstance->SetInventoryItems(Items);
				// }
